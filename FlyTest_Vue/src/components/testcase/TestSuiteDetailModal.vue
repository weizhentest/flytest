  ...
  >
    <a-spin :loading="loading" style="width: 100%">
      <div v-if="suiteDetail" class="suite-detail-content">
        <a-descriptions :column="2" bordered class="suite-descriptions">
...
.suite-detail-content :deep(.arco-descriptions) {
  overflow: hidden;
  border-radius: 14px;
...
.suite-detail-content :deep(.arco-descriptions-header) {
  background: rgba(248, 250, 252, 0.92);
}

.suite-detail-content :deep(.arco-descriptions-item-label) {
  background: rgba(248, 250, 252, 0.76);
  color: #42526d;
  font-weight: 600;
}

.suite-detail-content :deep(.arco-descriptions-item-value) {
  background: rgba(255, 255, 255, 0.98);
}

.suite-alert :deep(.arco-alert) {
  border-radius: 12px;
}
