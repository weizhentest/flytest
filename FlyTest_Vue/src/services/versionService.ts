...
const GITHUB_PACKAGE_JSON_URL = `https://raw.githubusercontent.com/${GITHUB_REPO}/main/FlyTest_Vue/package.json`
...
export async function checkLatestVersion(): Promise<VersionInfo> {
  ...
  const versionInfo: VersionInfo = {
    ...
    releaseNotes: 'Version source: weixiaoluan/flytest/FlyTest_Vue/package.json'
  }
