...
#### FlyTest Tools (FlyTest_tools.py) ✨ 开箱即用

- **服务端口**: 8006
- **后端地址**: `FLYTEST_BACKEND_URL`（默认：http://backend:8000）
- **API密钥**: `FLYTEST_API_KEY`（默认：flytest-default-mcp-key-2025）
...
**⚠️ 生产环境安全提示：**
- 系统会自动创建默认API Key（flytest-default-mcp-key-2025）
- 开发环境可直接使用
